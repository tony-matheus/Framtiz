  ...
  render: () => (
    <div className='flex flex-wrap gap-4'>
      ...
      <Button
        ...
        rightIcon={<Pause className='h-4 w-4' />}
      >
        Play/Pause
      </Button>
    </div>
...
export const CustomStyling: Story = {
  render: () => (
    <div className='flex flex-wrap gap-4'>
      <Button className='bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 border-purple-400'>
        Gradient Cyber
      </Button>
      <Button className='rounded-full border-green-400 text-green-400'>
        Rounded Cyber
      </Button>
      <Button className='shadow-lg hover:shadow-xl border-yellow-400 text-yellow-400'>
        Shadow Cyber
      </Button>
  ...
  render: () => (
    <div className='space-y-6'>
      <div className='text-center'>
        <h3 className='text-lg font-mono text-purple-300 mb-4'>
          Cyber Interface
        </h3>
        <div className='flex flex-wrap justify-center gap-4'>
          ...
          <Button variant='warning' leftIcon={<Upload className='h-4 w-4' />}>
            Upload Data
          </Button>
          <Button
            variant='destructive'
      ...
      <div className='text-center'>
        <h3 className='text-lg font-mono text-green-300 mb-4'>
          System Controls
        </h3>
        <div className='flex flex-wrap justify-center gap-4'>
          <Button size='icon' variant='default'>
