...
export const WithoutDismissButton: Story = {
  render: () => (
    <Dialog>
      <DialogTrigger asChild>
        <Button>Open (no X button)</Button>
      </DialogTrigger>
      <DialogContent showDismiss={false}>
        <DialogHeader>
          <DialogTitle>No Dismiss Button</DialogTitle>
          <DialogDescription>
            This dialog hides the close (X) button. Use footer actions to close.
          </DialogDescription>
        </DialogHeader>
        <DialogFooter>
          <DialogClose asChild>
        ...
        <div className="grid gap-4 py-4">
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <input
              ...
              className="col-span-3 rounded-md border border-input bg-transparent px-3 py-2 text-sm"
            />
          </div>
          <div className="grid grid-cols-4 items-center gap-4">
