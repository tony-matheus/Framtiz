...
export default function SettingsPage() {
  ...
  return (
    <AdminLayout>
      <AdminHeader systemStatus={systemStatus} title='SYSTEM_CONFIGURATION' />
      ...
      <div className='mt-8'>
        ...
        >
          <CyberSectionHeader
            title='PORTFOLIO_SETTINGS'
            subtitle='Configure your portfolio settings, API connections, and security parameters.'
          >
